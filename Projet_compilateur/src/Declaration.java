...
public class Declaration {
	...
	/**
	 * Permet de créer un nouvel objet de la classe IdFonc correspondant é une fonction du
	...
	public void ajoutConstanteParConstante(String ident){
		/*on vérifie que la constante est dans le tableau puis on la récupére pour la copier,
