...
public class YVMasm extends YVM {
	 ...
	 * complète l'entête avec les fonctions externes rassemblées dans un tableau de chaines. 
	 * 
	 * @param fichierOut
	 * 
	 * @see Ecriture#ecrireStringln(OutputStream, String)
	...
	public void recopierEntete(String fichierOut) {
		...
		if(!extern.isEmpty()){
			...
			// on itére sur le tableau pour récupérer tous ses éléments et les écrire
