 ...
 * @version 1.0
 * 
 * Classe générer à partir de JavaCC. Classe principale du programme (main). Les classes
 * ratachées à celle-ci on elles aussi étaient générées à partir de JavaCC.
 * 
 * @see YakaConstants
 * @see YakaTokenManager
 * @see Token
 * @see TokenMgrError
 * @see SimpleCharStream
 * @see ParseException
 */
 ...
 */
  ...
  static final public void affectation() throws ParseException {
    ...
    expression();
        ...
        /* Vider les piles pour Ã©valuer une autre expression */
