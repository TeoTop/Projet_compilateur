...
/**************************************/
  ...
  static final public void typeF() throws ParseException {
    ...
    case ENTIER:
      jj_consume_token(ENTIER);
                declaration.ajoutFonction("ENTIER");
      break;
    case BOOLEEN:
      jj_consume_token(BOOLEEN);
                declaration.ajoutFonction("BOOLEEN");
      break;
    default:
      jj_la1[1] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void type() throws ParseException {
    ...
    case ENTIER:
      jj_consume_token(ENTIER);
                declaration.ajoutVariableParTYPE("ENTIER");
      break;
    case BOOLEEN:
      jj_consume_token(BOOLEEN);
                declaration.ajoutVariableParTYPE("BOOLEEN");
      break;
    default:
      jj_la1[9] = jj_gen;
      jj_consume_token(-1);
 ...
 */
  ...
  static final public void opRel() throws ParseException {
    ...
    case EGAL:
      jj_consume_token(EGAL);
          expression.empileOpera("=");
          expression.setLastOpRel(YakaConstants.EGAL);
      break;
    case DIFF:
      jj_consume_token(DIFF);
          expression.empileOpera("<>");
          expression.setLastOpRel(YakaConstants.DIFF);
      break;
    case INF:
      jj_consume_token(INF);
          expression.empileOpera("<");
          expression.setLastOpRel(YakaConstants.INF);
      break;
    case INFEGAL:
      jj_consume_token(INFEGAL);
          expression.empileOpera("<=");
          expression.setLastOpRel(YakaConstants.INFEGAL);
      break;
    case SUP:
      jj_consume_token(SUP);
          expression.empileOpera(">");
          expression.setLastOpRel(YakaConstants.SUP);
      break;
    case SUPEGAL:
      jj_consume_token(SUPEGAL);
          expression.empileOpera(">=");
          expression.setLastOpRel(YakaConstants.SUPEGAL);
      break;
    default:
      jj_la1[25] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opAdd() throws ParseException {
    ...
    case ADD:
      jj_consume_token(ADD);
          expression.empileOpera("+");
          expression.setLastOpAdd(YakaConstants.ADD);
      break;
    case SUBNEG:
      jj_consume_token(SUBNEG);
          expression.empileOpera("-");
          expression.setLastOpAdd(YakaConstants.SUBNEG);
      break;
    case OU:
      jj_consume_token(OU);
          expression.empileOpera("ou");
          expression.setLastOpAdd(YakaConstants.OR);
      break;
    default:
      jj_la1[26] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opMul() throws ParseException {
    ...
    case MUL:
      jj_consume_token(MUL);
        expression.empileOpera("*");
          expression.setLastOpMul(YakaConstants.MUL);
      break;
    case DIV:
      jj_consume_token(DIV);
        expression.empileOpera("/");
          expression.setLastOpMul(YakaConstants.DIV);
      break;
    case ET:
      jj_consume_token(ET);
          expression.empileOpera("et");
          expression.setLastOpMul(YakaConstants.AND);
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opNeg() throws ParseException {
    ...
    case SUBNEG:
      jj_consume_token(SUBNEG);
          expression.empileOpera("-");
          expression.setLastOpNeg(YakaConstants.SUBNEG);
      break;
    case NON:
      jj_consume_token(NON);
          expression.empileOpera("non");
          expression.setLastOpNeg(YakaConstants.NOT);
      break;
    default:
      jj_la1[28] = jj_gen;
      jj_consume_token(-1);
